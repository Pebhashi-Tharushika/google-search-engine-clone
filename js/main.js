...
window.addEventListener('load', () => {
    ...
    // Update the text
    themeText.innerHTML = theme === "light" ? "Dark theme: Off" : "Dark theme: On";

    // Update the SVG icon
    themeImgSpan.innerHTML = theme === "light"
...
themeSetting.addEventListener('click', () => {
    ...
    // Update the text
    themeText.innerHTML = updatedTheme === "light" ? "Dark theme: On" : "Dark theme: Off";
